...
var wchar_t = require(getFile('wchar.js'));
...
var autoit_dll = ffi.Library(getFile(dll), autoit_functions);
...
function modify_arg_to_return_value(func){
    ...
    $[func] = function(){
        if(get_ret.type == 'wstring'){
            ...
            var buf = new Buffer.alloc(wchar_t.size * nBufSize);
    ...
    $[func].async = function(){
        if(get_ret.type == 'wstring'){
            ...
            if (args[get_ret.ex_arg] === undefined) {
              args[get_ret.ex_arg] = 256;
            }
